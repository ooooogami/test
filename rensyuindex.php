...
if( !empty($_POST['btn_submit']) ) {
  ...
  // 表示名の入力チェック
    ...
    // メッセージの入力チェック
	if ((empty($_POST['message'] ) or empty($_POST['view_name'])))  {
		$error_message= '名前、または本文が未記入です';
    $ng_alert ="<script type='text/javascript'>alert('".$error_message."');
    </script>";
    echo $ng_alert;
	}
  ...
  if( $file_handle = fopen( FILENAME, "a") ) {
    ...
    // 書き込み日時を取得
      ...
      $success_message = 'メッセージを書き込みました。';
			$ok_alert = "<script type='text/javascript'>alert('".$success_message."');
	    </script>";
			echo $ok_alert;
  	}
  }
